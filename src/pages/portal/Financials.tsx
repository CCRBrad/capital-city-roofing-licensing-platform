...
const Financials: React.FC = () => {
    return (
        <>
            <SEOHead title="Financials & Reporting | Operator Portal" description="Financials & Reporting module for Capital City Roofing operators." />
                ...
                <Card className="border-border shadow-navy-sm">
                    <CardContent className="p-16 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-muted-foreground max-w-md mx-auto">
                            We are building out the financials & reporting infrastructure. It will be available in the upcoming Q4 platform release.
                        </p>
                    </CardContent>
                </Card>
            </div>
