...
const TheModel: React.FC = () => {
    return (
        <>
            <SEOHead
                title="The Licensing Model | Capital City Roofing"
                description="Explore the blueprint that redefines the modern roofing company."
            />

            <section className="bg-navy-950 text-white py-24 md:py-32 relative text-center">
                <div className="container-custom relative z-10">
                    <span className="text-[hsl(38,75%,50%)] font-bold tracking-widest uppercase text-sm mb-4 block">A Franchise Alternative</span>
