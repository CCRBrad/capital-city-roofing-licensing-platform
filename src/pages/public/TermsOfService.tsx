...
const TermsOfService: React.FC = () => {
    return (
        <>
            <SEOHead
                title="Terms of Service | Capital City Roofing"
                description="The rules and guidelines for using our website."
            />

            <section className="bg-navy-950 text-white py-24 md:py-32 relative text-center">
                <div className="container-custom relative z-10">
                    <span className="text-[hsl(38,75%,50%)] font-bold tracking-widest uppercase text-sm mb-4 block">Legal Documentation</span>
