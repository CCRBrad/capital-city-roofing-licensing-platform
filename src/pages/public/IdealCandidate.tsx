...
const IdealCandidate: React.FC = () => {
    return (
        <>
            <SEOHead
                title="The Ideal Candidate | Capital City Roofing"
                description="See if you have what it takes to join our licensing platform."
            />

            <section className="bg-navy-950 text-white py-24 md:py-32 relative text-center">
                <div className="container-custom relative z-10">
                    <span className="text-[hsl(38,75%,50%)] font-bold tracking-widest uppercase text-sm mb-4 block">Who Are We Looking For?</span>
